...
class haffman_decode
{
  ...
  haffman_decode(String filepath)
  {
   ...
   haffmandecode([String? target_path]) {
    ...
    RandomAccessFile _fp = file_write3.openSync(mode: FileMode.write);
    var buffer=Uint8List(2*8192);
    ...
    void find_code(treenode_for_decompression node){
      ...
      if (node.left_child==null && node.right_child==null)
      {
        ...
        //xie huanchong
        buffer[bufferPosition++] = value3[0];
        if (bufferPosition == 16384) {
          if (bufferPosition > 0) {
            _fp.writeFromSync(buffer, 0, bufferPosition);
            bufferPosition = 0;
          }
        }
        //write2.add(value3);
...
/*void main()
{
  var tst=haffman_decode('C:\\Users\\fander\\Desktop\\新建文件夹\\新建文本文档.txt.haffman');
